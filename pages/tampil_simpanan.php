        ...
        <div id="page-wrapper">
              <div width="50px" height="180px">
                                ...
                                <thead>
                                            ...
                                            <?php
                                                $data=mysqli_query($konek,"SELECT * FROM simpanan");    
                                            ...
                                            <tbody>
                                            <tr>
                                                <td><?php echo $query['NO_SIMPANAN'] ?> </td>
                                                <td><?php echo $query['ID_MEMBER'] ?> </td>
                                                <td><?php echo $query['JUMLAH_SIMPANAN']?></td>
