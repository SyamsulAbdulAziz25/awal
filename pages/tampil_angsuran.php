       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;Background-color:#2E8B57">
        ...
        <div id="page-wrapper">
            <div width="50px" height="180px">
                                <center><h3>ANGSURAN </h3>
                                <hr></center>
                                <table class="table table-striped table-bordered" id="table" > 
                                <thead>
                                            <tr>
                                                <th width="10px">NO PINJAMAN</th>
                                                <th width="10px">NIK</th>
                                                <th width="10px">NAMA</th>
                                                <th width="10px">ANGSURAN KE</th>
                                                <th width="10px">SISA TENNOR</th>
                                                
                                            </tr>
                                </thead>
                                            <?php
                                                $data=mysqli_query($konek,"SELECT * FROM angsuran");    
                                ...
                                <tbody>                                                
                                            <tr>
                                                ...
                                                <td><?php echo $query['NIK']?></td>
                                                <td><?php echo $query['NAMA']?></td>
                                                <td><?php echo $query['ANGSURAN_KE']?></td>
                                                <td><?php echo $query['SISA_TENNOR']?></td>
