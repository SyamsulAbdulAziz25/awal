       ...
       <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;Background-color:#2E8B57">
        ...
        <div id="page-wrapper">
            ...
            <div width="50px" height="180px">          
                                <center><h3>PENGAMBILAN SIMPANAN/WITHDRAW</h3>
                                <hr></center>
                               <table class="table table-striped table-bordered" id="table"> 
                                <thead>
                                            ...
                                            <?php
                                                $data=mysqli_query($konek,"SELECT * FROM withdraw");    
                                            ...
                                            <tbody>    
                                            <tr>
                                                <td><?php echo $query['NO_WITHDRAW'] ?> </td>
                                                <td><?php echo $query['ID_MEMBER']?></td>
                                                <td><?php echo $query['JUMLAH_WITHDRAW']?></td>
                                                <td><?php echo $query['JENIS_SIMPANAN']?></td>
                                                <td><?php echo $query['TANGGAL_TRANSAKSI']?></td>
