...
<body>
                    ...
                    <div class="panel-body">
                        <form  method="post" action="pro_log.php">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <input class="form-control" placeholder="Password" id="password" name="password" value="" type="password">
                                </div>
                                <div class="checkbox">
                                    <label>
                                    ...
                                    <label>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input name="view" type="checkbox" value="View" onclick="viewPass()">View
                                    </label>
                                </div>
    ...
    <script type="text/javascript">
        ...
        function viewPass () {
           // int lihat=0;
             // body...
             var a=document.getElementById("password").type;
            if(a=="password"){
